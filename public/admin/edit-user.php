...
$id=$_REQUEST['id'];
$admin_user = $db->fetch_array_by_query('select * from admin where id='.intval($id));
$name = explode(" ", $admin_user['name']);
$ledger_id = $db->fetch_array_by_query('select * from ledger where id='.intval($admin_user['ledger_id']));
$user_detail = $db->fetch_array_by_query('select * from user_detail where user_id='.intval($admin_user['id']));
...
if(isset($_POST['command']) && $_POST['command']=='update-user'){
    // echo '<pre>';
    // print_r($_POST);
    // die();
    ...
    $ledger_res=$ledger_class->updateRecord($_POST);
    ...
    $res=$db->update($id,$arr, 'admin');
    $res=$id;
    if($res){
        $db->query("delete from user_detail where user_id = ".$res);
        $user_detail=array();
                    ...
                    <form action="" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-2 col-sm-12 col-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control form_height" name="prefix" id="" placeholder="" value="<?php echo $ledger_id['prefix'];  ?>">
                                         <input type="hidden" name="ledger_id" value="<?php echo $ledger_id['id'];  ?>">
                                    </div>
                                </div>
                                <div class="col-md-5 col-sm-12 col-12">
                                    <div class="form-group mb-3">
                                        <label for="exampleInputEmail1" class="label_all">First Name:</label>
                                        <input type="text" class="form-control form_height" name="first_name" id="" placeholder="" value="<?php echo $name[0];  ?>">
                                    </div>
                                </div>
                                <div class="col-md-5 col-sm-12 col-12">
                                    <div class="form-group mb-3">
                                        <label for="exampleInputEmail1" class="label_all">Last Name:</label>
                                        <input type="text" class="form-control form_height" name="last_name" id="" placeholder="" value="<?php echo $name[1];  ?>">
                                    </div>
                                </div>
                                <div class="col-md-5 col-sm-12 col-12">
                                    <div class="form-group mb-3">
                                        <label for="exampleInputEmail1" class="label_all">Email:</label>
                                        <input type="text" class="form-control form_height" name="email" id="" placeholder="" value="<?php echo $admin_user['email'];?>">
                                    </div>
                                </div>
                        ...
                        <div class="exp_card card px-4 py-4 mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-12 mb-5">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input input_checkbox1 business_check" name="allow_login" value="yes" <?php echo ($admin_user['allow_login']== 'yes' ? 'checked' : '');?>>
                                        </label>
                                ...
                                <div class="col-md-4 col-sm-12 col-12 ">
                                    <div class="form-group mb-1">
                                        ...
                                        <input type="text" class="form-control form_height" name="user_name" id="" placeholder="" value="<?php echo $admin_user['username'];?>">
                                    </div>
                                ...
                                <div class="col-md-4 col-sm-12 col-12 ">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="password" class="form-control form_height" name="password" id="" placeholder="" value="<?php echo $admin_user['password'];?>">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-12 col-12">
                                    <div class="form-group mb-3">
                                ...
                                <div class="col-md-5 col-sm-12 col-12 mt-3 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select class="choosen-index form-control" name="role" id="">
                                            ...
                                            ?>
                                            <option <?php echo ($admin_user['role_id']== $role['id'] ? 'selected' : '');?> value="<?= $role['id'] ?>"><?= $role['role'] ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-check mb-3">
                                    ...
                                    $location_heads = explode(",", $admin_user['head_id']);
                                    //print_r($location_heads);
                                    foreach($locations as $location){
                                         $tag_select = in_array($location["id"], $location_heads) ? 'checked' : '';
                                         // print_r($tag_select);
                                         // die();
                                        //if(in_array($location["id"], $location_heads)){ $tag_select = 'checked';}else{ $tag_select = ''; }
                                    ?>
                                    <div class="form-check mb-3">
                                        <label class="form-check-label">
                                            <input <?php echo $tag_select; ?> type="checkbox" class="form-check-input input_checkbox2" name="locs[]" value="<?= $location['id']; ?>" >
                                        </label>
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                    <div class="form-group" id="simple-date1">
                                        ...
                                        <input type="text" name="date_ledger" class="form-control date_tax_app" value="<?php echo $ledger_id['dob'];  ?>" id="simpleDataInput">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <select class=" form-control form_height" name="gender" id="">
                                            <option value="male" <?php echo ($ledger_id['gender']== 'male' ? 'selected' : '');?>>Male</option>
                                            <option value="female" <?php echo ($ledger_id['gender']== 'female' ? 'selected' : '');?>>Female</option>
                                            <option value="other" <?php echo ($ledger_id['gender']== 'other' ? 'selected' : '');?>>Other</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12 ">
                                    <div class="form-group">
                                        ...
                                        <select class=" form-control form_height" name="martial_status" id="">
                                            <option value="married" <?php echo ($ledger_id['status']== 'married' ? 'selected' : '');?> >Married</option>
                                            <option value="unmarrried" <?php echo ($ledger_id['status']== 'unmmarried' ? 'selected' : '');?>>Unmarried</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6  col-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control form_height" name="blood_group" id="" placeholder="" value="<?php echo $user_detail['blood_group'];  ?>">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                    <div class="form-group mb-3">
                                        <label for="exampleInputEmail1" class="label_all">Mobile Number:</label>
                                        <input type="text" class="form-control form_height" name="mobile_number" id="" placeholder="" value="<?php echo $user_detail['contact'];  ?>">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                    <div class="form-group mb-3">
                                        <label for="exampleInputEmail1" class="label_all">Alter Native Contact:</label>
                                        <input type="text" class="form-control form_height" name="alter_number" id="" placeholder="" value="<?php echo $user_detail['alternative_contact'];  ?>">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                    <div class="form-group mb-3">
                                        <label for="exampleInputEmail1" class="label_all">Family Contact Number:</label>
                                        <input type="text" class="form-control form_height" name="family_contact_number" id="" placeholder="" value="<?php echo $user_detail['family_contact'];  ?>">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                    <div class="form-group mb-3">
                                        <label for="exampleInputEmail1" class="label_all">Facebook Link:</label>
                                        <input type="text" class="form-control form_height" name="facebook_link" id="" placeholder="" value="<?php echo $user_detail['fb_link'];  ?>">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                    <div class="form-group mb-3">
                                        <label for="exampleInputEmail1" class="label_all">Twitter:</label>
                                        <input type="text" class="form-control form_height" name="twitter_link" id="" placeholder="" value="<?php echo $user_detail['twitter_link'];  ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control form_height" name="guardian_name" id="" placeholder="" value="<?php echo $user_detail['gardian_name'];  ?>">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                    <div class="form-group mb-3">
                                        <label for="exampleInputEmail1" class="label_all">ID Proof Name:</label>
                                        <input type="text" class="form-control form_height" name="id_proof_name" id="" placeholder="" value="<?php echo $user_detail['id_proof_name'];  ?>">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                    <div class="form-group mb-3">
                                        <label for="exampleInputEmail1" class="label_all">ID Proof Number:</label>
                                        <input type="number" class="form-control form_height" name="id_proof_number" id=""  value="<?php echo $user_detail['id_proof_number'];  ?>">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12 ">
                                    <div class="form-group ">
                                        <label for="permanent_address" class="label_all">Permanent Address:</label>
                                        <textarea class="form-control" placeholder="" rows="4" name="permanent_address" cols="50" id="" value=""><?php echo $user_detail['permanant_address'];  ?></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label for="permanent_address" class="label_all">Current Address:</label>
                                        <textarea class="form-control" value="" placeholder="" rows="4" name="current_address" cols="50" id=""><?php echo $user_detail['current_address'];  ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control form_height" name="account_holder_name" id=""  value="<?php echo $user_detail['account_holder_name'];  ?>">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                    <div class="form-group mb-3">
                                        <label for="exampleInputEmail1" class="label_all">Account Number:</label>
                                        <input type="text" class="form-control form_height" name="account_number" id=""  value="<?php echo $user_detail['account_number'];  ?>">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                    <div class="form-group mb-3">
                                        <label for="exampleInputEmail1" class="label_all">Bank Name:</label>
                                        <input type="text" class="form-control form_height" name="bank_name" id="" value="<?php echo $user_detail['bank_name'];  ?>">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                    <div class="form-group mb-3">
                                        <label for="exampleInputEmail1" class="label_all">Bank Identifier Code:</label>
                                        <input type="text" class="form-control form_height" name="bank_identifer_code" value="<?php echo $user_detail['bank_id_code'];  ?>" id="" >
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                    <div class="form-group mb-3">
                                        <label for="exampleInputEmail1" class="label_all">Branch:</label>
                                        <input type="text" class="form-control form_height" name="bank_branch" id="" value="<?php echo $user_detail['branch_id'];  ?>">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                    <div class="form-group mb-3">
                                        <label for="exampleInputEmail1" class="label_all">Tax Payer ID:</label>
                                        <input type="text" class="form-control form_height" name="tax_payer_id" id="" value="<?php echo $user_detail['tax_payer_id'];  ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-md-12 col-12 text-center">
                                <button type="submit" name="command" value="update-user" class="btn btn-primary btn-big submit_user_button px-4" id="">Save</button>
                            </div>
                        </div>
                    </form>
                </div>
